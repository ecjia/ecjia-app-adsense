...
class admin extends ecjia_admin {
	...
	public function init() {
		...
		if ( ! $position_id) {
		    return $this->showmessage("丢失参数广告位“position_id”", ecjia::MSGTYPE_HTML | ecjia::MSGSTAT_ERROR, array('links' => [['text' => '返回广告位列表', 'href' => RC_Uri::url('adsense/admin_position/init')]]));
		}
