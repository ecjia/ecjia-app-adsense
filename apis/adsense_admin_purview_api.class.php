...
class adsense_admin_purview_api extends Component_Event_Api {
    ...
    public function call(&$options) {
        $purviews = array(
        	...
        	array('action_name' => RC_Lang::get('adsense::adsense.ads_add'), 	'action_code' => 'adsense_add', 	'relevance' => ''),
        	...
        	array('action_name' => RC_Lang::get('adsense::adsense.add_ads_position'), 		'action_code' => 'ad_position_add', 	'relevance' => ''),
