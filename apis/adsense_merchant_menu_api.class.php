 ...
 * @author songqianqian
 */
class adsense_merchant_menu_api extends Component_Event_Api {
	public function call(&$options) {
		$menus = ecjia_merchant::make_admin_menu('merchant_adsense_manage', __('广告'), '', 9)->add_icon('fa-bullhorn')->add_purview(array('mh_cycleimage_manage','mh_shortcut_manage','mh_adsense_position_manage','mh_adsense_group_manage'))->add_base('adsense');
		$submenus = array(
