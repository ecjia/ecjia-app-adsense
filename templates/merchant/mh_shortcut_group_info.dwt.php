...
ecjia.merchant.mh_shortcut.shortcut_group_info();
</script>
<!-- {/block} -->
                            ...
                            <div class="col-lg-8" style="padding-left:0px;">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">菜单组名称：</label>
...
<!-- 									<div class="form-group"> -->
<!-- 									 	<label class="control-label col-lg-3">菜单组代号：</label> -->
<!--                                      	<div class="controls col-lg-8"> -->
<!--                                              <select class="form-control"  name="" id=""> -->
<!--                                                   <option value="0" selected="selected" >请选择菜单组代号</option> -->
<!--                                              </select> -->
<!--                                         </div> -->
<!-- 									</div> -->
                                    ...
                                    <div class="form-group">
 									...
 									<div class="form-group">
				                        <label class="control-label col-lg-3">菜单组描述：</label>
				                        <div class="controls col-lg-8 ">
			                      	...
			                      	<div class="form-group">
                                        ...
                                        <div class="controls col-lg-8">
                                            ...
                                            <span class="help-block">在此可设置前台调用该菜单组的菜单显示数量。</span>
                                        </div>
                                    </div>
