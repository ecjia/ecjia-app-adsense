...
ecjia.merchant.mh_cycleimage.cycleimage_group_info();
</script>
<!-- {/block} -->
                            ...
                            <div class="col-lg-8" style="padding-left:0px;">
                                <fieldset>
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}轮播组名称：{/t}</label>
...
<!--                                                   <option value="0" selected="selected" >请选择轮播组代号</option> -->
<!--                                              </select> -->
<!--                                         </div> -->
<!-- 									</div> -->
                                    
                                    <div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}轮播组代号：{/t}</label>
                                        <div class="controls col-lg-8">
											...
											{/if}
											<span class="help-block">{t domain="adsense"}轮播组调用标识，且在同门店下该标识不可重复。{/t}</span>
                                        </div>
                                        <span class="input-must"><span class="require-field" style="color:#FF0000,">*</span></span>
                                    </div>
                                    
 									<div class="form-group">
				                        <label class="control-label col-lg-3">{t domain="adsense"}轮播组描述：{/t}</label>
				                        <div class="controls col-lg-8 ">
			                      	...
			                      	<div class="form-group">
                                        <label class="control-label col-lg-3">{t domain="adsense"}可展示数量最大值：{/t}</label>
                                        <div class="controls col-lg-8">
                                            <input class="form-control" type="text" name="max_number" id="max_number" value="{$data.max_number}" />
                                            <span class="help-block">{t domain="adsense"}在此可设置前台调用该轮播组的轮播图显示数量。{/t}</span>
                                        </div>
                                    </div>
							            ...
							            <div class="panel panel-info">
							                <div class="panel-heading">
							                    <a data-toggle="collapse" data-parent="#accordionTwo" href="#collapseNine" class="accordion-toggle">
							                        ...
							                        <h4 class="panel-title">{t domain="adsense"}其它信息{/t}</h4>
							                    </a>
							                </div>
							                <div id="collapseNine" class="panel-collapse collapse in">
						              			<div class="panel-body">
			                                        <div class="form-group">
							              				<label class="control-label col-lg-3">{t domain="adsense"}宽度：{/t}</label>
							              				<div class="col-lg-9">
							                            	<input class="form-control" name="ad_width" value="{$data.ad_width}" type="text" placeholder='{t domain="adsense"}像素{/t}'>
							                            	<span class="help-block">{t domain="adsense"}建议轮播组宽度单位为Px{/t}</span>
							                          	</div>
							              			</div>
