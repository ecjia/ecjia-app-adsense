            ...
            <div class="panel">
                <div class="panel-body">
                	<div class="col-lg-3">
						...
						<a href="{$action_link.href}" class="btn btn-primary data-pjax"><i class="fa fa-plus"></i> 添加轮播组</a>	
					</div>
						...
						<div class="panel-body panel-body-small">
								<h2 class="page-header">
									...
									<div class="pull-right">
										<a data-toggle="ajaxremove" class="ajaxremove btn btn-primary data-pjax"  data-msg="您要删除该轮播组么？"  href='{RC_Uri::url("adsense/admin_cycleimage/delete_group","position_id={$position_id}&city_id={$city_id}")}' title="删除"><i class="fa fa-trash-o"></i> 删除轮播组</a>
										<a href='{RC_Uri::url("adsense/admin_cycleimage/edit_group","position_id={$position_id}&city_id={$city_id}")}' class="btn btn-primary data-pjax" title="编辑"><i class="fa fa-plus"></i> 编辑轮播组</a>
									</div>
									{/if}
								</h2>
									...
									<table class="table table-striped table-hover table-hide-edit ecjiaf-tlf">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<i class="cursor_pointer fa {if $item.enabled eq '1'}fa-check {else}fa-times{/if}" data-trigger="toggle_on_sale" data-url='{RC_Uri::url("adsense/admin_cycleimage/toggle_show","position_id={$position_id}&city_id={$city_id}&show_client={$show_client}")}' data-id="{$item.ad_id}"></i>
												</td>
