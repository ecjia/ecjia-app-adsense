	...
	<div class="span12">
		<form class="form-horizontal" action='{url path="adsense/admin_group/constitute_insert" args="position_id={$position_id}&city_id={$city_id}"}' method="post" name="theForm">
			<div class="tab-content">
				<fieldset>
					<div class="control-group choose_list span12" data-url="{url path='adsense/admin_group/get_goods_list'}">
						<div class="ecjiaf-cb">
							<div class="f_l m_r5">
							...
							<a class="btn" data-toggle="searchGoods">搜索</a>
						</div>
					...
					<div class="control-group draggable">
						<div class="ms-container " id="ms-custom-navigation">
							...
							<div class="ms-selection">
								<div class="custom-header custom-header-align">组合广告位</div>
								<ul class="ms-list nav-list-content">
									<!-- {foreach from=$link_goods_list item=link_goods key=key} -->
										<li class="ms-elem-selection">
											<input type="hidden" value="{$link_goods.position_id}" name="position_id[]" />
											<!-- {$link_goods.position_name} -->
